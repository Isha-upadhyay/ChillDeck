    ...
    <main className="min-h-screen bg-[#0B0B10] text-white px-10 py-12">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">
          All your generated presentations at one place.
        </p>
          ...
          {!loading &&
            presentations.map((p) => (
              ...
              >
                {/* THUMBNAIL */}
                <div
                  className="h-32 w-full bg-gradient-to-br from-indigo-300/20 to-purple-300/20
                ...
                <div className="p-4">
                  <div className="flex justify-between mb-2">
                    {/* SLIDE COUNT */}
                    <span
                      className="px-3 py-1 rounded-full text-xs bg-indigo-600/20 
                    ...
                    <DropdownMenu>
                      ...
                      >
                        ...
                        {folders.length > 0 && (
                          <>
                            <p className="px-2 pt-2 pb-1 text-[11px] text-gray-400">
                              Move to folder
                            </p>
                            {folders.map((folder) => (
                              <DropdownMenuItem
                                ...
                                onClick={async (e) => {
                                  e.stopPropagation();
                                  try {
                                    await assignPresentationToFolder(
                                      folder.id,
                                      p.presentation_id,
                                    );
                          ...
                          onClick={async (e) => {
                            ...
                            if (confirm("Delete this presentation?")) {
                              ...
                              setPresentations((prev) =>
                                prev.filter(
                                  (x) =>
                                    x.presentation_id !== p.presentation_id,
                                ),
                              );
                            }
                          }}
